...
point1 = pointOrthog(2,:); 
point2 = pointOrthog(6,:);
...
figure; 
ax = subplot(1,1,1)
plotCenter3d(brainGridData,ax,pointOrthog,color1,angle2);
hold on;
scatter3(bregma(1),bregma(2),bregma(3),'r','filled'); 
...
for k = 1:3
    ...
    %%
    [shankPlane,shankLine,shankSurface3d,shankLine2d] = rotateAndSliceProbePlane(coronalAngleR,APAngleR,spinAngleR,rpoint1,template);
    ...
    coronalAngleDeg = rad2deg(coronalAngleR); % angle from coronal plane
    APAngleDeg = rad2deg(APAngleR);
