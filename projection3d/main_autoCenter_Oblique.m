...
maskPath{4} = '/997/8/343/1065/771/987/931/'; % pons
%%
...
for i = 1:4
    ...
    [cpoint] = autoProjectionCenter(dataFolder,mask3d,nameList1);
    ...
    if i==1
        title('auto oblique slice-ZoomIn');
    end
    %%    
    % get oblique slice atlas index
    ylim1 = [min(pointOrthog2d(:,1))-20,max(pointOrthog2d(:,1))+20];
